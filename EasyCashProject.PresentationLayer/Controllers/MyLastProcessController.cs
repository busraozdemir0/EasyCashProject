...
namespace EasyCashProject.PresentationLayer.Controllers
{
    public class MyLastProcessController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            int id = context.CustomerAccounts.Where(x => x.AppUserID == user.Id && x.CustomerAccountCurrency == "Türk Lirası").Select(y => y.CustomerAccountID).FirstOrDefault(); // Sisteme login olan kullanicinin id'sine gore CustomerAccount tablosundan CustomerAccountID alanini cekiyoruz.
