...
{
	// IdentityError'dan donen ing mesajlari turkcelestirmek icin
	public class CustomIdentityValidator : IdentityErrorDescriber
	{
		// Sifrenin en az kac karakter olmasi gerektigini turkce olarak belirtecek olan error describer
